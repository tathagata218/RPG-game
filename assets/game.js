$(function(){
    ...
    var cellHPCountPow="enemyHealth='100' counterattackPower='12'";
    var gokuHPCountPow="enemyHealth='180' counterattackPower='18'";
    var friezaHPCountPow="enemyHealth='120' counterattackPower='16'";
    var gohanHPCountPow="enemyHealth='130' counterattackPower='15'";
//   -----------------------------------------------------------------------------------------------------------------------------
//   -----------------------------------------------------------------------------------------------------------------------------
//   -----------------------------------------------------------------------------------------------------------------------------  
    ...
    $("#char1").click(function(){
        ...
        $(".enemyImg").click(function(){
            ...
            $("#attackBtn").click(function(){
                ...
                if(newenemyHealth<=0 && mainusercharHealth>0 && count<3){
                ...
                else if (count==3 && newenemyHealth<=0 && mainusercharHealth>0){
     ...
     var userPic="<h5>Cell</h5><img "+imgSize+" src="+cellImg+" alt='GokuImg'><p id='cellhpID' attackPoints=''>HP:"+cellHP+"</p>";
        ...
        $(".enemyImg").click(function(){
            ...
            $("#attackBtn").click(function(){
                ...
                if(newenemyHealth<=0 && count<3 && mainusercharHealth>0){
                    console.log(newenemyHealth);
                    $(thisPicture).fadeOut();
                    $("#displayHP").fadeOut();
                    //$(".enemyImg").click();
...
//   ----------------------------------------------------------------------------------------------------------------------------- 
    ...
    $("#char3").click(function(){
        var userPic="<h5>Frieza</h5><img "+imgSize+" src="+friezaImg+" alt='GokuImg'><p id='gokuhpID' attackPoints=''>HP:"+firezaHP+"</p>";
        var enemyPic1="<h5>Goku</h5><img "+imgSize+" src="+gokuImg+" alt='charecter1Img'><p id='cellhpID'>HP:"+gokuHP+"</p>";
        var enemyPic2="<h5>Cell</h5><img "+imgSize+" src="+cellImg+" alt='charecter1Img'><p id='firezahpID'>HP:"+cellHP+"</p>";
        var enemyPic3="<h5>Gohan</h5><img "+imgSize+" src="+gohanImg+" alt='charecter1Img'><p id='gohanID'>HP:"+gohanHP+"</p>";
...
//   ----------------------------------------------------------------------------------------------------------------------------- 
    ...
    $("#char4").click(function(){
       var userPic="<h5>Gohan</h5><img "+imgSize+" src="+gohanImg+" alt='GokuImg'><p id='gokuhpID' attackPoints=''>HP:"+gohanHP+"</p>";
        var enemyPic1="<h5>Cell</h5><img "+imgSize+" src="+cellImg+" alt='charecter1Img'><p id='cellhpID'>HP:"+cellHP+"</p>";
        var enemyPic2="<h5>Frieza</h5><img "+imgSize+" src="+friezaImg+" alt='charecter1Img'><p id='firezahpID'>HP:"+firezaHP+"</p>";
        var enemyPic3="<h5>Goku</h5><img "+imgSize+" src="+gokuImg+" alt='charecter1Img'><p id='gohanID'>HP:"+gokuHP+"</p>";
